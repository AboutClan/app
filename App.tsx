...
/* ===========================
   Force Update Config
=========================== */
const FORCE_UPDATE_VERSION_ANDROID = '1.3.10';
const FORCE_UPDATE_VERSION_IOS = '1.1.2';
...
function Section({
  ...
  useEffect(() => {
    const unsub = messaging().onMessage(async remoteMessage => {
      try {
        ...
        const channelId = String(data.channelId ?? appConfig.pushNotificationSelector);
  ...
  return (
    <WebView
      ref={webviewRef}
      source={{uri: appConfig.uri}}style={{ flex: 1 }} // 👈 이 줄을 추가하여 WebView가 공간을 차지하도록 합니다.
